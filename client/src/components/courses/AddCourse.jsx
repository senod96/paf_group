...
const AddCourse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const [imageUrl, videoUrl] = await Promise.all([handleImageSubmit(), handleVideoSubmit()]);
  ...
  return (
    <Box sx={{ p: 3, maxWidth: 1200, margin: '0 auto' }} className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 font-sans">
